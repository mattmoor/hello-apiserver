...
func GetOpenAPIDefinitions(ref openapi.ReferenceCallback) map[string]openapi.OpenAPIDefinition {
	return map[string]openapi.OpenAPIDefinition{
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.Build": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Ref: ref("github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildSpec", "github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						"kind": {
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.Build"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.Build", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildSchemeFns": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "Build Functions and Structs",
					Properties: map[string]spec.Schema{
						"DefaultSchemeFns": {
							SchemaProps: spec.SchemaProps{
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
						...
						"steps": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.StepSpec"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.SourceSpec", "github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.StepSpec"},
		},
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildStatusStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.BuildStrategy": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.RepoSourceSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.SourceSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
			...
			Dependencies: []string{
				"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.RepoSourceSpec", "github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.StorageSourceSpec"},
		},
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.StepSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "StepSpec defines a step of the Build",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
						...
						"volumes": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.VolumeSpec"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.VolumeSpec"},
		},
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.StorageSourceSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "StorageSourceSpec defines the input to the Build",
					Properties: map[string]spec.Schema{
						"bucket": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
		...
		"github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1.VolumeSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "VolumeSpec defines a step of the Build",
					Properties: map[string]spec.Schema{
						"name": {
							SchemaProps: spec.SchemaProps{
								Type:   []string{"string"},
		...
		"k8s.io/api/autoscaling/v2alpha1.CrossVersionObjectReference": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "CrossVersionObjectReference contains enough information to let you identify the referred resource.",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscaler": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Description: "status is the current information about the autoscaler.",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerStatus"),
							},
						},
					},
				},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerSpec", "k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
		},
		"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerCondition": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "HorizontalPodAutoscalerCondition describes the state of a HorizontalPodAutoscaler at a certain point.",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerList": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
						...
						"items": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscaler"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscaler", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
		},
		"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						"scaleTargetRef": {
							SchemaProps: spec.SchemaProps{
								...
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.CrossVersionObjectReference"),
							},
						},
						"minReplicas": {
							SchemaProps: spec.SchemaProps{
						...
						"metrics": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/api/autoscaling/v2alpha1.MetricSpec"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.CrossVersionObjectReference", "k8s.io/api/autoscaling/v2alpha1.MetricSpec"},
		},
		"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
						...
						"currentMetrics": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/api/autoscaling/v2alpha1.MetricStatus"),
										},
									},
								},
							},
						...
						"conditions": {
							SchemaProps: spec.SchemaProps{
								...
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
											Ref: ref("k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerCondition"),
										},
									},
								},
							},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.HorizontalPodAutoscalerCondition", "k8s.io/api/autoscaling/v2alpha1.MetricStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
		},
		"k8s.io/api/autoscaling/v2alpha1.MetricSpec": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MetricSpec specifies how to scale based on a single metric (only `type` and one other matching field should be set at once).",
					Properties: map[string]spec.Schema{
						...
						"object": {
							SchemaProps: spec.SchemaProps{
								Description: "object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.ObjectMetricSource"),
							},
						},
						"pods": {
							SchemaProps: spec.SchemaProps{
								Description: "pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.PodsMetricSource"),
							},
						},
						"resource": {
							SchemaProps: spec.SchemaProps{
								Description: "resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.ResourceMetricSource"),
							},
						},
					},
					Required: []string{"type"},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.ObjectMetricSource", "k8s.io/api/autoscaling/v2alpha1.PodsMetricSource", "k8s.io/api/autoscaling/v2alpha1.ResourceMetricSource"},
		},
		"k8s.io/api/autoscaling/v2alpha1.MetricStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "MetricStatus describes the last-read state of a single metric.",
					Properties: map[string]spec.Schema{
						...
						"object": {
							SchemaProps: spec.SchemaProps{
								Description: "object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.ObjectMetricStatus"),
							},
						},
						"pods": {
							SchemaProps: spec.SchemaProps{
								Description: "pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value.",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.PodsMetricStatus"),
							},
						},
						"resource": {
							SchemaProps: spec.SchemaProps{
								Description: "resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.",
								Ref:         ref("k8s.io/api/autoscaling/v2alpha1.ResourceMetricStatus"),
							},
						},
					},
					Required: []string{"type"},
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.ObjectMetricStatus", "k8s.io/api/autoscaling/v2alpha1.PodsMetricStatus", "k8s.io/api/autoscaling/v2alpha1.ResourceMetricStatus"},
		},
		"k8s.io/api/autoscaling/v2alpha1.ObjectMetricSource": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ObjectMetricSource indicates how to scale on a metric describing a kubernetes object (for example, hits-per-second on an Ingress object).",
					Properties: map[string]spec.Schema{
			...
			Dependencies: []string{
				"k8s.io/api/autoscaling/v2alpha1.CrossVersionObjectReference", "k8s.io/apimachinery/pkg/api/resource.Quantity"},
		},
		"k8s.io/api/autoscaling/v2alpha1.ObjectMetricStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ObjectMetricStatus indicates the current value of a metric describing a kubernetes object (for example, hits-per-second on an Ingress object).",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.PodsMetricSource": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "PodsMetricSource indicates how to scale on a metric describing each pod in the current scale target (for example, transactions-processed-per-second). The values will be averaged together before being compared to the target value.",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.PodsMetricStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "PodsMetricStatus indicates the current value of a metric describing each pod in the current scale target (for example, transactions-processed-per-second).",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.ResourceMetricSource": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ResourceMetricSource indicates how to scale on a resource metric known to Kubernetes, as specified in requests and limits, describing each pod in the current scale target (e.g. CPU or memory).  The values will be averaged together before being compared to the target.  Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.  Only one \"target\" type should be set.",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/autoscaling/v2alpha1.ResourceMetricStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ResourceMetricStatus indicates the current value of a resource metric known to Kubernetes, as specified in requests and limits, describing each pod in the current scale target (e.g. CPU or memory).  Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source.",
					Properties: map[string]spec.Schema{
		...
		"k8s.io/api/extensions/v1beta1.NetworkPolicySpec": {
			...
			Dependencies: []string{
				"k8s.io/api/extensions/v1beta1.NetworkPolicyIngressRule", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
		},
		...
		"k8s.io/api/extensions/v1beta1.PodSecurityPolicySpec": {
			...
			Dependencies: []string{
				"k8s.io/api/extensions/v1beta1.FSGroupStrategyOptions", "k8s.io/api/extensions/v1beta1.HostPortRange", "k8s.io/api/extensions/v1beta1.RunAsUserStrategyOptions", "k8s.io/api/extensions/v1beta1.SELinuxStrategyOptions", "k8s.io/api/extensions/v1beta1.SupplementalGroupsStrategyOptions"},
		},
		...
		"k8s.io/api/networking/v1.NetworkPolicySpec": {
			...
			Dependencies: []string{
				"k8s.io/api/networking/v1.NetworkPolicyIngressRule", "k8s.io/apimachinery/pkg/apis/meta/v1.LabelSelector"},
		},
