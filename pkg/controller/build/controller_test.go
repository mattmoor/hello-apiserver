...
import (
	...
	. "github.com/mattmoor/hello-apiserver/pkg/client/clientset_generated/clientset/typed/experimental/v1alpha1"
...
var _ = Describe("Build controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "build-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.ExperimentalV1alpha1Client.Builds("build-controller-test-handler")
