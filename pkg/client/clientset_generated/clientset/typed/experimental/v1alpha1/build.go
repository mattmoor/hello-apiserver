...
import (
	...
	scheme "github.com/mattmoor/hello-apiserver/pkg/client/clientset_generated/clientset/scheme"
...
func newBuilds(c *ExperimentalV1alpha1Client, namespace string) *builds {
	return &builds{
		client: c.RESTClient(),
		ns:     namespace,
	}
