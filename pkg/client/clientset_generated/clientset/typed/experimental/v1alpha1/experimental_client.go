...
import (
	v1alpha1 "github.com/mattmoor/hello-apiserver/pkg/apis/experimental/v1alpha1"
	"github.com/mattmoor/hello-apiserver/pkg/client/clientset_generated/clientset/scheme"
...
// ExperimentalV1alpha1Client is used to interact with features provided by the experimental.mattmoor.io group.
type ExperimentalV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExperimentalV1alpha1Client) Builds(namespace string) BuildInterface {
